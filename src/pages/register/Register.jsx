    ...
    return (
      ...
      <div className="card backdrop-blur-md bg-white/20 border border-white/30 w-full max-w-sm shrink-0 shadow-2xl">
        <div className="card-body">
            <h1 className="text-center text-2xl font-bold mb-1">Create Account</h1>
          ...
          <p>Already have an Account? <Link to="/auth/login" className='font-semibold hover:underline text-blue-500'>Login</Link></p>
          <div className="max-w-60 mx-auto w-full flex items-center gap-2">
