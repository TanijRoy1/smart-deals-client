...
const Product = ({product}) => {
    ...
    return (
        <div className='bg-white rounded-xl shadow-md hover:shadow-2xl'>
            ...
            <Link to={`/product-details/${_id}`} className='btn btn-outline border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white w-full mt-2 transition-all duration-300'>View Details</Link>
            </div>
        </div>
    );
};
